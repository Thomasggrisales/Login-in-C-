...
namespace WebAppCorreo.Datos
{
    ...
    {
        //private static string CadenaSQL = "Server=DESKTOP-MQ4PQ9O\\SQLEXPRES; DataBase=DBPRUEBA; Trusted_Connection=True; TrustServerCertificate=True;";
        private static string CadenaSQL = "Data Source=DESKTOP-MQ4PQ9O\\SQLEXPRESS;Initial Catalog= DBPRUEBA;Integrated Security=True;";
